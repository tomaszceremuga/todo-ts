const btn: HTMLButtonElement = document.querySelector("#add-btn");
const input: HTMLInputElement = document.querySelector("#task-name");
const ul: HTMLElement = document.querySelector("#tasks-lis");
const inputLow: HTMLInputElement = document.querySelector("#low");
const inputMedium: HTMLInputElement = document.querySelector("#medium");
const inputHigh: HTMLInputElement = document.querySelector("#high");
